...
shop.shoppingCart.TableGenerator = function TableGenerator() {
   ...
   var addDeleteButton = function addDeleteButton(productId) {
      intentations++;
      append('<td class="zentrierterText rightMostColumn"><button type="button" class="removeButton" onclick="shop.ui.Actions.removeProductFromShoppingCart(\'' + productId + '\');"><img src="images/cancel.svg"></button></td>');
      intentations--;
   };
